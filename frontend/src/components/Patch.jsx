...
export const Patch = () => {
    ...
    return <div class="max-w-md m-auto mt-6">
        <div  class="border-t-4 border-blue-600 overflow-hidden rounded shadow-lg">
        <h3 class="text-xl text-center mt-8 mb-8">id : {params.postid}</h3>
   
        <div class="px-4 mb-4">  <input 
    ...
    class="border border-gray rounded w-full p-3"
    placeholder="Body"
    type="text" name="body"  onChange={(e) => setBody(e.target.value)}
     /></div>
        <div class="px-4 mb-4"> <input
    class="border border-gray rounded w-full p-3"
    placeholder="Image"
